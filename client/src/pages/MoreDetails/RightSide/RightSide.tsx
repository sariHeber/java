    ...
    <>
      <Box className={classes.box}>
        <FormControl fullWidth>
          <InputLabel  style={{ color: WHITE_COLOR  }} className={classes.inputLable}>Branch Name</InputLabel>
          <Select
        ...
        <FormControl fullWidth>
          <InputLabel style={{ color: WHITE_COLOR  }} className={classes.inputLable}>Report</InputLabel>
          <Select
           data-testid="selectBranchName"
            sx={{ color: WHITE_COLOR  }}
