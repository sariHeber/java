...
import { WHITE_COLOR } from "../../helpers/colorsConstant";

import allure from "../Dashboard/ScannersGraph/scannerIcon/allure.png";
import openApi from "../Dashboard/ScannersGraph/scannerIcon/openAPI.png";
import junit from "../Dashboard/ScannersGraph/scannerIcon/junit.png";
import prisma from "../Dashboard/ScannersGraph/scannerIcon/prisma.png";
import blackduck from "../Dashboard/ScannersGraph/scannerIcon/blackduck.png";
...
export const MoreDetails = () => {
  ...
  useEffect(() => {
    const func = async () => {
      const response = await getScannerByIdFromServer(id || "");
      setScannerById(response.data);
      setScannerName(response.data.scannerName);
    };
  ...
  return (
    ...
    <img aria-label="logo" src={dellLogo} className={classes.logo}/>
    </div>
    <div className={classes.iconName}>
    <p className={classes.title}>{scannerName}</p>
    <img aria-label="icon" className={classes.iconScanner} src={iconsByScannerName[scannerName as iconKey]}/>
    </div>
        ...
        <Grid  container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 } } sx={{paddingLeft: 1}}>
          <Grid item xs={5}>
            <LeftSide
