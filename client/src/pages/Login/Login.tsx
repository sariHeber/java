...
import { USER_DETAILS_ERROR } from '../../helpers/loginConstant';
          ...
          >
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate >
              <TextField
                ...
                margin="normal"
                required
                sx={{ input: { color: WHITE_COLOR }, marginTop: 6, width: 300, }}
                id="userName"
                label="UserName"
                name="userName"
              ...
              <TextField
                className={classes.textField}
                sx={{ input: { color: WHITE_COLOR }, marginTop: 4, width: 300 }}
                margin="normal"
                required
                fullWidth
                name="password"
              ...
              <Grid container>
                <Grid item xs>
                  <Link style={{ color: WHITE_COLOR, textDecoration: 'none' }} href="#" variant="body2">
                    Forgot password?
                  </Link>
                </Grid>
              </Grid>
