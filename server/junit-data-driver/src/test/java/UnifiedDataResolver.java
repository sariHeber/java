...
public class UnifiedDataResolver implements ParameterResolver {
    ...
    public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        ...
        unifiedDataScanner.setProductName("testJunitUnifiedData");
        unifiedDataScanner.setMicroserviceName("testJunitUnifiedData");
        unifiedDataScanner.setTestName("UnitTestOftestJunitUnifiedData");
        unifiedDataScanner.setVersion("0.0.0");
        unifiedDataScanner.setScannerName("junit");
